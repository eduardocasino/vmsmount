...
# Codepage: 437
#
# Translator: Bernd Blaauw
#
# Spaces before text must be kept. Be sure that no spaces are
# added to the end of the lines.
#
0.1:\nUsage: VMSMOUNT [/H][/V|/Q] [/L:<schijfletter>] [/B:<size>[K]]\n
0.2:\t/H                 - Geeft dit bericht weer en stopt\n
0.3:\t/V                 - Verbaal: Geeft informatie weer over systeembronnen\n
0.4:\t/Q                 - Quiet: Omits copyright message\n
0.5:\t/L:<schijfletter>  - Toe te kennen schijfletter\n
0.6:\t                     (indien weggelaten, gebruikt eerst beschikbare)\n
0.7:\t/B:<size[K]>       - Size of read/write buffer\n
0.8:\t                     (4K default, higher values increase performance)\n
...
1.3: FOUT: Systeem draait niet under VMWARE.\n
1.4: FOUT: Ongeldige schijfletter %c (LASTDRIVE is %c)\n
1.5: FOUT: Kan de List-Of-Lists niet achterhalen!\n
1.6: FOUT: Redirectors zijn not toegestaan.\n
1.7: FOUT: Reeds geinstalleerd.\n
