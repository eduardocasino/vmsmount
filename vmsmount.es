...
0.1:\t/H                  - Muestra este mensaje y termina\n
0.2:\t/V                  - Muestra informaci¢n extra del sistema\n
0.3:\t/L:<letra unidad>   - Letra de unidad donde montar las carpetas\n
0.4:\t                      (si se omite, usa la primera disponible)\n
...
1.11:ADVERTENCIA: No pudo cargarse tabla Unicode: %s
1.12:ADVERTENCIA: TZ no definido, los tiempos se mostrar n en UTC.\n
1.13:ERROR: No se pudo crear la tabla de traducci¢n de nombres de recursos\n       compartidos.\n
1.14:ERROR: Opci¢n no v lida: %c \n
1.15:ERROR: Par metro no v lido: %s\n
1.16:ADVERTENCIA: P gina de c¢digos activa no encontrada
1.17:. Se usar  cp437.\n
1.18:ADVERTENCIA: Formato de archivo incorrecto: %s
1.19:ADVERTENCIA: No se encontr¢ la tabla Unicode: %s
